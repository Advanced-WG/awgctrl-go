...
//
// cachedInterfaces is lazily populated and refreshed on cache miss (see
// interfaceHandle). Devices() always calls refreshInterfaceCache() so
// callers always see the current set of interfaces.
type Client struct {
...
var (
	deviceClassNetGUID     = windows.GUID{Data1: 0x4d36e972, Data2: 0xe325, Data3: 0x11ce, Data4: [8]byte{0xbf, 0xc1, 0x08, 0x00, 0x2b, 0xe1, 0x03, 0x18}}
	deviceInterfaceNetGUID = windows.GUID{Data1: 0xcac88484, Data2: 0x7515, Data3: 0x4c03, Data4: [8]byte{0x82, 0xe6, 0x71, 0xa8, 0x7a, 0xba, 0xc3, 0x61}}
	devpkeyWgName          = windows.DEVPROPKEY{
		FmtID: windows.DEVPROPGUID{Data1: 0x65726957, Data2: 0x7547, Data3: 0x7261, Data4: [8]byte{0x64, 0x4e, 0x61, 0x6d, 0x65, 0x4b, 0x65, 0x79}},
